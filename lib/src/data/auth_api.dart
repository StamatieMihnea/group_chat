...
class AuthApi {
  ...
  Future<app_user.User> createUser({required String email, required String password}) async {
  ...
  Future<app_user.User> login({required String email, required String password}) async {
